        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    LastStatusUp = table.Column<bool>(type: "boolean", nullable: true),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AlertRules_MonitorId_IsEnabled",
                table: "AlertRules",
                columns: new[] { "MonitorId", "IsEnabled" });

            migrationBuilder.CreateIndex(
                name: "IX_MonitorChecks_MonitorId_Timestamp",
                table: "MonitorChecks",
                columns: new[] { "MonitorId", "Timestamp" });

            migrationBuilder.CreateIndex(
                name: "IX_Monitors_UserId_Name",
                table: "Monitors",
