...
namespace KeepTabs.Database.Migrations
{
    ...
    [Migration("20251130205307_InitialCreate")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KeepTabs.Entities.AlertLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KeepTabs.Entities.AlertRule", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KeepTabs.Entities.MonitorCheck", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("KeepTabs.Entities.User", b =>
                {
            ...
            modelBuilder.Entity("KeepTabs.Entities.AlertLog", b =>
                {
                    b.HasOne("KeepTabs.Entities.AlertRule", "AlertRule")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("KeepTabs.Entities.User", null)
                        .WithMany()
